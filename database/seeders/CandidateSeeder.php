    ...
    public function run()
    {
        DB::table('candidate_models')->insert([
            [
                ...
                'voteCount' => '15',
                'profilePicture' => '/images/bryan.png',
                'electionId' => 1,
            ],
            [
                ...
                'voteCount' => '16',
                'profilePicture' => '/images/rafi.png',
                'electionId' => 1,
            ],[
                ...
                'mission' => 'Inovasi dalam Pendidikan dan Teknologi, Peningkatan Kualitas Layanan dan Fasilitas, Pengembangan Karir dan Profesionalisme.',
                'voteCount' => '15',
                'profilePicture' => '/images/yobel.png',
                'electionId' => 2,
            ],
            [
                'name' => 'Derrend Hansen',
                ...
                'mission' => 'Pembinaan Kemampuan Soft Skills, Kebersamaan dan Kepedulian Sosial,Inklusi dan Keberagaman',
                'voteCount' => '16',
                'profilePicture' => '/images/derrend.png',
                'electionId' => 2,
            ],
            [
                'name' => 'Willas Tobing',
                ...
                'mission' => 'Inovasi dalam Pendidikan dan Teknologi, Peningkatan Kualitas Layanan dan Fasilitas, Pengembangan Karir dan Profesionalisme.',
                'voteCount' => '15',
                'profilePicture' => '/images/wilas.png',
                'electionId' => 3,
            ],
            [
                'name' => 'Nathan Darell',
